...
export default function Dashboard() {
  ...
  const circlePos = useRef(Array.from({ length: SNAKE_COUNT }, () => ({ x: 0, y: 0 })));
  const coords = useRef({ x: -999, y: -999 });
  const snakeRaf = useRef<number>(0);

  useEffect(() => {
    const onSnakeMove = (e: MouseEvent) => {
    ...
    function animateCircles() {
      ...
      circleRefs.current.forEach((el, i) => {
        ...
        el.style.scale = String((SNAKE_COUNT - i) / SNAKE_COUNT);
        circlePos.current[i].x = x;
        circlePos.current[i].y = y;
        const next = circlePos.current[i + 1] ?? circlePos.current[0];
        x += (next.x - x) * 0.3;
        y += (next.y - y) * 0.3;
      });
      snakeRaf.current = requestAnimationFrame(animateCircles);
    }
    animateCircles();

    return () => {
      window.removeEventListener("mousemove", onSnakeMove);
...
>>>>>>> 480ba97 (added changes in frontend)
  ...
  const statCards = [
    { label: "Active Patients", value: statsData.active_patients, icon: Heart, color: "#E8554E", bg: "rgba(232,85,78,0.12)", delay: 0 },
    { label: "Verified Donors", value: statsData.active_donors, icon: Users, color: "#6366F1", bg: "rgba(99,102,241,0.12)", delay: 80 },
    { label: "Guardian Circles", value: statsData.guardian_circles, icon: Shield, color: "#1DB88E", bg: "rgba(29,184,142,0.12)", delay: 160 },
    { label: "At-Risk Donors", value: statsData.at_risk_donors, icon: AlertTriangle, color: "#E8952A", bg: "rgba(232,149,42,0.12)", delay: 240 },
    { label: "Open Requests", value: statsData.open_requests, icon: Droplets, color: "#8B5CF6", bg: "rgba(139,92,246,0.12)", delay: 320 },
    { label: "Transfusions / Mo", value: statsData.transfusions_this_month, icon: TrendingUp, color: "#10B981", bg: "rgba(16,185,129,0.12)", delay: 400 },
  ];

  const glassCard: React.CSSProperties = {
    background: "rgba(10, 4, 15, 0.52)",
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: "transparent" }}>
      ...
      {/* ── Snake cursor circles ── */}
      {Array.from({ length: SNAKE_COUNT }).map((_, i) => (
        <div
          key={i}
          ...
          style={{
            ...
            pointerEvents: "none",
            zIndex: 99999999,
            backgroundColor: SNAKE_COLORS[i % SNAKE_COLORS.length],
          }}
        />
      ))}
      ...
      >
        <div>
          <div className="section-label" style={{
            ...
            letterSpacing: "0.15em", color: "#E8554E", marginBottom: 4,
          }}>
            — COMMAND CENTER
          </div>
          <h1 style={{
            fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 800,
            letterSpacing: "-0.02em", margin: 0, color: "var(--text-main)",
          }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <motion.button whileTap={{ scale: 0.97 }} onClick={() => navigate("/urgent")}
            ...
            style={{ cursor: "pointer", padding: "7px 14px", border: "1px solid var(--crimson-border)", display: "flex", alignItems: "center", gap: 5 }}>
            <Zap size={11} /> {statsData.open_requests} Urgent
          </motion.button>

          <motion.button whileTap={{ scale: 0.97 }} onClick={() => navigate("/at-risk")}
            className="badge badge-warning"
            style={{ cursor: "pointer", padding: "7px 14px", border: "1px solid rgba(232,149,42,0.3)", display: "flex", alignItems: "center", gap: 5 }}>
...
>>>>>>> 480ba97 (added changes in frontend)
      ...
      {/* ── Page content ── */}
      <div className="page-content" style={{ position: "relative", zIndex: 1, padding: "24px 28px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 20, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <motion.div
              ...
              style={{
                ...
                background: "linear-gradient(135deg, rgba(99,102,241,0.06) 0%, rgba(10,4,15,0.55) 60%)",
                backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)",
              }}
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
                <div>
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "#E8554E", letterSpacing: "0.12em", marginBottom: 6 }}>
                    GUARDIAN CIRCLE · AI-MATCHED DONORS
                  </div>
                  <h2 style={{ fontFamily: "var(--font-display)", fontSize: 18, fontWeight: 800, margin: 0, letterSpacing: "-0.01em", color: "var(--text-main)" }}>
                    Patient Arjun
                  </h2>
            ...
            <motion.div
              ...
              style={{ ...glassCard, padding: "22px 24px" }}
            >
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <h2 style={{ fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 700, margin: 0, color: "var(--text-main)" }}>
          ...
          <motion.div
            ...
            style={{
              ...glassCard, position: "sticky", top: 80,
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexShrink: 0 }}>
              <div>
                <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "#E8554E", letterSpacing: "0.12em", marginBottom: 4 }}>
                  LIVE FEED
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <h2 style={{ fontFamily: "var(--font-display)", fontSize: 15, fontWeight: 700, margin: 0, color: "var(--text-main)" }}>
                    Real-time Events
                  </h2>
                  <div style={{
            ...
            <div style={{ flex: 1, overflowY: "auto", paddingRight: 4 }}>
              <AnimatePresence initial={false}>
                {events.length === 0 ? (
                  ...
                  events.map((ev: any) => {
                    const color =
                      ev.urgency === "critical" ? "var(--crimson-light)"
                        : ev.urgency === "urgent" ? "var(--warning)"
                          : "var(--text-muted)";
                    return (
                      <motion.div
                        key={ev.id}
                        ...
                        style={{
                          ...
                          background: ev.urgency !== "normal" ? `${color}08` : "rgba(255,255,255,0.03)",
            ...
            <div style={{ marginTop: 12, paddingTop: 12, borderTop: "1px solid rgba(255,255,255,0.07)", flexShrink: 0 }}>
              <AlertBanner />
            </div>
          </motion.div>
